...
const How = () => {
  return (
    <section
      className="min-h-[calc(100dvh-72px)] pt-[72px]
        flex flex-col gap-6 items-center
        w-full max-w-screen-2xl 
        text-center 
        md:text-start 
        lg:flex-row lg:gap-12 
        2xl:gap-32 container 
        bg-gradient-to-b from-[#fff3ef] to-white
        "
    >
      <div
        className="flex
      ...
      >
        ...
        /> */}
        <div className="h-[300px] w-[300px] md:h-[345px] md:w-[512px]">
          <svg
